...
class StaffController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->search)){
			...
			$search_condition = "(
				...
				staff.phone LIKE ? OR 
				staff.email LIKE ? OR 
				staff.residence LIKE ? OR 
				staff.introduction LIKE ? OR 
				staff.photo LIKE ? OR 
				staff.relationship LIKE ? OR 
				staff.gender LIKE ? OR 
				staff.username LIKE ? OR 
				staff.password LIKE ?
			)";
			$search_params = array(
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("name","phone","email","residence","introduction","photo","relationship","gender","username","password");
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("id","name","phone","email","residence","introduction","photo","relationship","gender","username","password");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$cpassword = $postdata['confirm_password'];
			$password = $postdata['password'];
