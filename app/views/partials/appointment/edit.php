                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <input id="ctrl-contact"  value="<?php  echo $data['contact']; ?>" type="text" placeholder="Enter Contact"  required="" name="contact"  class="form-control " />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <textarea placeholder="Enter Motive" id="ctrl-motive"  required="" rows="5" name="motive" class="htmleditor form-control"><?php  echo $data['motive']; ?></textarea>
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="form-group ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <textarea placeholder="Enter Notes" id="ctrl-notes"  required="" rows="5" name="notes" class="htmleditor form-control"><?php  echo $data['notes']; ?></textarea>
                                                            <!--<div class="invalid-feedback animated bounceIn text-center">Please enter text</div>-->
                                                        </div>
                                                    </div>
                                                </div>
