                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <textarea placeholder="Enter Motive" id="ctrl-motive"  required="" rows="5" name="motive" class="htmleditor form-control"><?php  echo $this->set_field_value('motive',""); ?></textarea>
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="form-group ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <textarea placeholder="Enter Notes" id="ctrl-notes"  required="" rows="5" name="notes" class="htmleditor form-control"><?php  echo $this->set_field_value('notes',""); ?></textarea>
                                                            <!--<div class="invalid-feedback animated bounceIn text-center">Please enter text</div>-->
                                                        </div>
                                                    </div>
                                                </div>
