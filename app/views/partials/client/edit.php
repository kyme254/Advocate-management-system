...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="edit"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Edit  Client</h4>
                </div>
            </div>
        </div>
    </div>
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <input id="ctrl-phone_number"  value="<?php  echo $data['phone_number']; ?>" type="text" placeholder="Enter Phone Number"  required="" name="phone_number"  class="form-control " />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group ">
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <label class="control-label" for="identification_number">Identification Number <span class="text-danger">*</span></label>
                                                </div>
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <input id="ctrl-identification_number"  value="<?php  echo $data['identification_number']; ?>" type="text" placeholder="Enter Identification Number"  required="" name="identification_number"  class="form-control " />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
