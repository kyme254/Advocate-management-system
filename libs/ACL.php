	...
	public static $role_pages = array(
			'admin' =>
						array(
							...
							'newcase' => array('list','view','add','edit', 'editfield','delete','import_data'),
							'appointment' => array('list','view','add','edit', 'editfield','delete','import_data'),
							'casestudy' => array('list','view','add','edit', 'editfield','delete','import_data'),
							'document' => array('list','view','add','edit', 'editfield','delete','import_data'),
							'todolist' => array('list','view','add','edit', 'editfield','delete','import_data'),
							'mytask' => array('list','view','add','edit', 'editfield','delete','import_data'),
							'client' => array('list','view','add','edit', 'editfield','delete','import_data'),
							'staff' => array('list','view','add','edit', 'editfield','delete','import_data')
						),
		
			'users' =>
						array(
							'appointment' => array('list','view','add')
						),
		
			'staff' =>
						array(
							'newcase' => array('list','view','add'),
							'appointment' => array('list','view','add'),
							'casestudy' => array('list','view','add'),
							'document' => array('list','view','add'),
							'todolist' => array('list','view','add'),
							'mytask' => array('list','view','add'),
							'client' => array('list','view','add','edit', 'editfield','delete')
						),
		
			'client' =>
						array(
							'newcase' => array('list','view','add'),
							'appointment' => array('view','add','edit', 'editfield'),
							'casestudy' => array('list','view','add')
						)
		);
